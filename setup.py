...
CYTHON_MODULES = ['microscopes.irm.definition',
                  'microscopes.irm.model',
                  'microscopes.irm._model',
                  ]

LIBRARY_DEPENDENCIES = ["microscopes_common", "microscopes_irm",
...
basedir = join_path(os.path.dirname(__file__), 'microscopes', 'irm')
